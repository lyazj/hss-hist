...
try:
    ...
    hep.cms.label(data=False, label='Preliminary', year=2018, lumi=59.7)
hep.histplot(hists[0], histtype='step', label='probHbc')
hep.histplot(hists[1], linestyle='--', histtype='step', label='probHothers')
hep.histplot(hists[2], linestyle='--', histtype='step', label='probQCD')
hep.histplot(hists[3], histtype='step', label='HbcVSQCD')
plt.yscale('log')
plt.xlabel('ParT Score')
plt.ylabel('Unweighted Events')
plt.legend(loc='upper right')
...
try:
    ...
    hep.cms.label(data=False, label='Preliminary', year=2018, lumi=59.7)
hep.histplot(weighted_hists[0], histtype='step', label='probHbc')
hep.histplot(weighted_hists[1], linestyle='--', histtype='step', label='probHothers')
hep.histplot(weighted_hists[2], linestyle='--', histtype='step', label='probQCD')
hep.histplot(weighted_hists[3], histtype='step', label='HbcVSQCD')
plt.yscale('log')
plt.xlabel('ParT Score')
plt.ylabel('Events')
plt.legend(loc='upper right')
...
try:
    ...
    hep.cms.label(data=False, label='Preliminary', year=2018, lumi=59.7)
hep.histplot(weighted_hists_400toInf[0], histtype='step', label='probHbc')
hep.histplot(weighted_hists_400toInf[1], linestyle='--', histtype='step', label='probHothers')
hep.histplot(weighted_hists_400toInf[2], linestyle='--', histtype='step', label='probQCD')
hep.histplot(weighted_hists_400toInf[3], histtype='step', label='HbcVSQCD')
plt.yscale('log')
plt.xlabel('ParT Score')
plt.ylabel('Events')
plt.legend(loc='upper right')
